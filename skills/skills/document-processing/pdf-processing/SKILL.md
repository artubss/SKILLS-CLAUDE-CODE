...
page = reader.pages[0]
page.rotate(90)  # Rotaciona 90 graus no sentido horário
writer.add_page(page)
...
**IMPORTANTE**: Nunca use caracteres Unicode de subscrito/sobrescrito (₀₁₂₃₄₅₆₇₈₉, ⁰¹²³⁴⁵⁶⁷⁸⁹) em PDFs ReportLab. As fontes integradas não incluem esses glifos, fazendo com que apareçam como caixas sólidas pretas.
...
# Sobrescritos: use a tag <super>
squared = Paragraph("x<super>2</super> + y<super>2</super>", styles['Normal'])
```

Para texto desenhado no canvas (não objetos Paragraph), ajuste manualmente o tamanho e a posição da fonte em vez de usar subscritos/sobrescritos Unicode.
...
# Rotacionar páginas
qpdf input.pdf output.pdf --rotate=+90:1  # Rotaciona página 1 por 90 graus
