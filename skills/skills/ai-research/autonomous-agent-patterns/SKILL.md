...
description: "Padrões de design para construir agentes de codificação autônomos. Cobre integração de tools, sistemas de permissão, automação de browser e workflows com intervenção humana. Use ao construir agentes IA, projetar APIs de tools, implementar sistemas de permissão ou criar assistentes de codificação autônomos."
---

# 🕹️ Padrões de Agentes Autônomos

> Padrões de design para construir agentes de codificação autônomos, inspirado em [Cline](https://github.com/cline/cline) e [OpenAI Codex](https://github.com/openai/codex).

## Quando Usar Esta Skill

Use esta skill quando:

- Construir agentes IA autônomos
- Projetar APIs de tool/function calling
- Implementar sistemas de permissão e aprovação
- Criar automação de browser para agentes
- Projetar workflows com intervenção humana

---

## 1. Arquitetura Principal do Agente
...
### 2.2 Tools Essenciais para Agente
...
## 3. Padrões de Permissão e Segurança
...
## 4. Automação de Browser

### 4.1 Padrão de Tool de Browser
...
### 5.1 Padrões de Injeção de Contexto
...
- [ ] Decomposição clara de tarefas
- [ ] Granularidade apropriada de tools
- [ ] Tratamento de erros em cada etapa
- [ ] Visibilidade de progresso para o usuário
...
- [ ] UI de aprovação é clara
- [ ] Atualizações de progresso fornecidas
- [ ] Desfazer/rollback disponível
